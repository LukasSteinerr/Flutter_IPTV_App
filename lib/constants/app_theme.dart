...
class AppTheme {
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: const ColorScheme.dark(
      ...
      surface: AppColors.netflixBlack,
    ),
    ...
    textTheme: const TextTheme(
      ...
      bodyLarge: TextStyle(color: AppColors.netflixWhite, fontSize: 16),
      bodyMedium: TextStyle(color: AppColors.netflixLightGrey, fontSize: 14),
    ),
